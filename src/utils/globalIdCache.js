...
class GlobalIdCache {
   ...
   * @param {Array} items - Array of layout items
   */
  initialize(items) {
    this.cache.clear();
   ...
   * @param {string} oldId - The old ID to remove
   * @param {string} newId - The new ID to add
   * @returns {boolean} - True if update was successful, false if new ID already exists
   */
